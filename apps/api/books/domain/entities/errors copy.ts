...
export type InvalidBookSourceError = InvalidBookSourceUrlError | InvalidBookSourceExtensionError;
...
export class InvalidBookNonAuthorsError extends DomainError {
  _kind = "error" as const;
  code = "InvalidBookNonAuthors" as const;
}
export class BookAuthorsIsEmptyError extends DomainError {
  _kind = "error" as const;
  code = "BookAuthorsIsEmpty" as const;
}
export class BookAuthorDuplicatedError extends DomainError {
  _kind = "error" as const;
  code = "BookAuthorDuplicated" as const;
}

export type InvalidBookAuthorError = InvalidBookNonAuthorsError | InvalidBookAuthorNameError;
...
export class InvalidBookContentIsEmptyError extends DomainError {
  _kind = "error" as const;
  code = "InvalidBookContentIsEmpty" as const;
}

export type InvalidBookContentError =
